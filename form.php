	...
	if(isset($_POST['pt']) AND is_numeric($_POST['pt']) AND $_POST['pt']>0){
		...
		elseif(isset($_POST['Submit']) AND ($_POST['Submit']=='Next >' OR $_POST['Submit']=='Submit')){
			switch($_POST['pt']){
							...
							case 'Radio-1':
								if(isset($_POST['RESULT_RadioButton-24']) AND array_key_exists($_POST['RESULT_RadioButton-24'],$post_sts) AND $post_sts[$_POST['RESULT_RadioButton-24']]!='' AND $post_sts[$_POST['RESULT_RadioButton-24']]!=null){
									...
									if(isset($_POST['RESULT_RadioButton-21']) AND array_key_exists($_POST['RESULT_RadioButton-21'],$post_stss) AND $post_stss[$_POST['RESULT_RadioButton-21']]!='' AND $post_stss[$_POST['RESULT_RadioButton-21']]!=null){
										...
										if($error==false){
											if($_POST['RESULT_RadioButton-24']=='Radion-1' AND $_POST['RESULT_RadioButton-21']=='Radio-0')  $_SESSION['data1']['ship_container_c'] = ((isset($_POST['RESULT_TextField-22']) AND is_numeric($_POST['RESULT_TextField-22']) AND $_POST['RESULT_TextField-22']>0) ? $_POST['RESULT_TextField-22'] : 1);
											if($_POST['RESULT_RadioButton-24']=='Radion-1' AND $_POST['RESULT_RadioButton-21']=='Radio-0')  $_SESSION['data1']['ship_container_s'] = ((isset($_POST['RESULT_RadioButton-23']) AND array_key_exists($_POST['RESULT_RadioButton-23'],$post_container_size) AND $post_container_size[$_POST['RESULT_RadioButton-23']]!='' AND $post_container_size[$_POST['RESULT_RadioButton-23']]!=null) ? $post_container_size[$_POST['RESULT_RadioButton-23']] : '20 ft container');
				...
				case 3:
					$shown_type = 2;
					if(isset($_SESSION['data1']) AND isset($_POST['RESULT_TextField-37']) AND is_numeric($_POST['RESULT_TextField-37']) AND $_POST['RESULT_TextField-37']>0){
							...
							if(isset($_POST['RESULT_TextField-49']) AND $_POST['RESULT_TextField-49']!='' AND $_POST['RESULT_TextField-49']!=null){
								if(isset($_POST['RESULT_TextField-50']) AND $_POST['RESULT_TextField-50']!='' AND $_POST['RESULT_TextField-50']!=null){
									if(isset($_POST['RESULT_TextField-51']) AND $_POST['RESULT_TextField-51']!='' AND $_POST['RESULT_TextField-51']!=null){
										//if(isset($_POST['RESULT_TextField-52']) AND $_POST['RESULT_TextField-52']!='' AND $_POST['RESULT_TextField-52']!=null){
											if(true or isset($_POST['RESULT_TextArea-53']) AND $_POST['RESULT_TextArea-53']!='' AND $_POST['RESULT_TextArea-53']!=null){
												$error = false;
												$data = array();
												//RESULT_TextField-520
												$data['company'] = "";
												if(isset($_POST['RESULT_TextField-520']) AND $_POST['RESULT_TextField-520']!='' AND $_POST['RESULT_TextField-520']!=null){
													$data['company'] = $_POST['RESULT_TextField-520'];
												}
												...
												$data['phone'] = $_POST['RESULT_TextField-49'];
												$data['email'] = $_POST['RESULT_TextField-50'];
												$data['firstname'] = $_POST['RESULT_TextField-51'];
												//$data['lastname'] = $_POST['RESULT_TextField-52'];
												...
												mysql_query("UPDATE `quote` SET `tid` = '".$tid."' WHERE `id`='".$id."'") or die(mysql_error());
												mysql_close($con);
		...
		<table border='1' bordercolor='#777' style='margin-left:auto;margin-right:auto;width:90%;border-collapse:collapse;border-color:#777;font-size:12px;'>
			<tbody>
				...
				<tr style='background-color:#ccc;text-align:center;color:#3a3a3a;'>
					...
					<td colspan='1' width='15%'>Total Weight(kg)</td>
					<td colspan='2' width='15%'>Isurance</td>
					<td colspan='3' width='30%'>Description</td>
				</tr>
				<tr style='background-color:#fff;text-align:center;font-weight:bold;'>
					<td colspan='1' style='padding:15px 0;color:#ff3333;'>". $_SESSION['data2']['n_item'] ."</td>
					<td colspan='2'>". $_SESSION['data2']['dims'] ."</td>
					<td colspan='1'>". $_SESSION['data2']['t_weight'] ."</td>
					<td colspan='2'>". $_SESSION['data2']['insurance'] ."</td>
				...
				<tr style='background-color:#ccc;text-align:center;color:#3a3a3a;'>
					<td colspan='2' width='10%'>Preferred Contact Method</td>
					...
					<td colspan='2' width='15%'>Shipping Date</td>
					<td colspan='2' width='15%'>Exact Date</td>
				</tr>
				<tr style='background-color:#fff;text-align:center;font-weight:bold;'>
					<td colspan='2'>". $data['contact_method'] ."</td>
					<td colspan='1'>". $data['contact_time'] ."</td>
					<td colspan='1'>". $data['note'] ."</td>
					<td colspan='1'>". $_SESSION['data']['type'] ."</td>
					<td colspan='2'>". $_SESSION['data']['date'] ."</td>
					<td colspan='2'>". $_SESSION['data']['exact_datedate'] ."</td>
				</tr>
			</tbody>
		</table>
...
/*	$body = "Hi,<br>
	...
	Phone : ".$data['phone']."<br>
	Email : ".$data['email']."<br>
	Preferred Contact Method : ".$data['contact_method']."<br>
	Preferred Contact Time : ".$data['contact_time']."<br>
	Note : ".$data['note']."<br>
	=======================================================<br>
	Item Count : ".$_SESSION['data2']['n_item']."<br>
	Dimension(LxWxH)(cm) : ".$_SESSION['data2']['dims']."<br>
	Total Weight(kg) : ".$_SESSION['data2']['t_weight']."<br>
	Insurance : ".$_SESSION['data2']['insurance']."<br>
	Description : ".$_SESSION['data2']['desc']."<br>
	=======================================================<br>
	From : ".$_SESSION['data']['from']."<br>
	To : ".$_SESSION['data']['to']."<br>
	Shipping Method : ".$_SESSION['data1']['type']."<br>
	Shipping Container : ".$_SESSION['data1']['ship_container']."<br>
	Shipping Sub-Type : ".$_SESSION['data1']['ship_type']."<br>
	<br>
	From State : ".$_SESSION['data']['from_state']."<br>
	To State : ".$_SESSION['data']['to_state']."<br>
	<br>
	From Location : ".$_SESSION['data1']['from']."<br>
	To Location : ".$_SESSION['data1']['to']."<br>
	=======================================================<br>
	Package Type : ".$_SESSION['data']['type']."<br>
	Date : ".$_SESSION['data']['date']."<br>
	Exact Date : ".$_SESSION['data']['exact_date']."<br>
...
//echo $body."<br>";
	...
	$headers .= 'From: Booking Parcel <quote@bookingparcel.com>' . "\r\n";
	$headers .= 'X-Sender: quote@bookingparcel.com' . "\r\n";
	//mail("e.fakhimi@esmaielfakhimi.ir", $subject, $quote_body, $headers);
	mail($data['email'], $subject, $customer_body, $headers);
	mail("quote@bookingparcel.com", $subject, $quote_body, $headers);
	unset($_SESSION['data']);
	...
	<form method="post" id="FSForm" action="form.php" enctype="application/x-www-form-urlencoded" onsubmit="return Vromansys.Form.processSubmit(this);">
		...
		<div id="q1700" class="q required highlight">
			...
			<label class="question top_question" for="RESULT_TextField-1800">Which State of <?php echo $_SESSION['data']['from']; ?>:&nbsp;<span class="icon">&nbsp;</span></label>
			<input type="text" name="RESULT_TextField-1800" class="text_field" id="RESULT_TextField-1800  size="10" maxlength="255" value="<?php echo ($_SESSION['data']['from_state']!='Not Sure' ? $_SESSION['data']['from_state'] : ""); ?>" >
		</div>
		<div class="clear"></div>
		<div id="q1701" class="q required highlight">
			<a class="item_anchor" name="ItemAnchor1801"></a>
			<label class="question top_question" for="RESULT_TextField-1801">Which State of <?php echo $_SESSION['data']['to']; ?>:&nbsp;<span class="icon">&nbsp;</span></label>
			<input type="text" name="RESULT_TextField-1801" class="text_field" id="RESULT_TextField-1801  size="10" maxlength="255" value="<?php echo ($_SESSION['data']['to_state']!='Not Sure' ? $_SESSION['data']['to_state'] : ""); ?>" >
		</div>
		<div class="clear"></div>
	...
	<form method="post" id="FSForm" action="form.php" enctype="application/x-www-form-urlencoded" onsubmit="return Vromansys.Form.processSubmit(this);">
		<div style="display:none;">
			...
			<input type="hidden" name="Referrer" id="Referrer" value="http://www.dfsworldwide.com/">
			<input type="text" name="subject_line" id="subject_line" autocomplete="off"><label for="subject_line">subject_line</label>
		</div>
...
if(isset($arr) AND is_array($arr)){
	foreach($arr as $k=>$v){
		...
		<tr class="matrix_row_<?php echo $col ?>">
			...
			<td><input type="text" name="RESULT_MatrixTextField_weight-38-<?php echo $_c ?>" class="text_field" size="4" maxlength="4" value="<?php echo $v[1] ?>"></td>
...
?>
			<tr class="matrix_row_<?php echo $col ?>">
				...
				<td><input type="text" name="RESULT_MatrixTextField_weight-38-<?php echo $_c ?>" class="text_field" size="4" maxlength="4" value=""></td>
				<td><img class="svg add" height="16" src="images/icons/formIcons/add.svg"> 
					<img class="gif add" height="16" src="images/icons/fam/add.png">
					<img class="svg del" height="16" src="images/icons/formIcons/delete.svg"> 
					<img class="gif del" height="16" src="images/icons/fam/delete.png">
			...
			<input type="hidden" name="MaxAnswers" value="10">
		</div>
		...
		<div id="q742" class="q required">
			...
			<table class="inline_grid">
				<tr>
					<td><input type="radio" name="RESULT_RadioButton-422" class="multiple_choice" id="RESULT_RadioButton-422_0" value="Yes" <?php if((isset($_SESSION['data2']['dg']) AND $_SESSION['data2']['dg']=='Yes') OR (isset($_POST['RESULT_RadioButton-422']) AND $_POST['RESULT_RadioButton-422']=='Yes')) echo " checked='checked'"; ?>/><label for="RESULT_RadioButton-422_0" >Yes</label></td>
				</tr>
				<tr>
					<td><input type="radio" name="RESULT_RadioButton-422" class="multiple_choice" id="RESULT_RadioButton-422_1" value="No" <?php if((isset($_SESSION['data2']['dg']) AND $_SESSION['data2']['dg']=='No') OR (isset($_POST['RESULT_RadioButton-422']) AND $_POST['RESULT_RadioButton-422']=='No')) echo " checked='checked'"; ?>/><label for="RESULT_RadioButton-422_1" >No</label></td>
				</tr>
			</table>
		</div>
