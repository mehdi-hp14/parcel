    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                ...
                axios.post('/customer/contents/posts/' + this.$route.params.id + '/update', form_data, {
                    headers: {
        ...
        watch: {
            ...
            searchCat: {
                handler(val) {
                    ...
                    axios.post('/customer/contents/categories/search', {val})
                        .then(res => {
            ...
            searchTags: {
                handler(val) {
                    ...
                    axios.post('/customer/contents/posts/search-tags', {val})
                        .then(res => {
                            this.count = res.data.length
        ...
        mounted() {
            axios.post('/customer/contents/posts/' + this.$route.params.id + '/edit').then(r => {
