                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="pending-switch"
                                               name="status[]"
                                               value="pending"
                                               @if(request('status') && in_array('pending',request('status'))) checked @endif
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="hold-switch"
                                               name="status[]"
                                               value="hold"
                                               @if(request('status') && in_array('hold',request('status'))) checked @endif
                                               @if($initialRequest) checked @endif
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="active-status"
                                               name="status[]"
                                               value="active"
                                               @if(request('status') && in_array('active',request('status'))) checked @endif
                                               @if($initialRequest) checked @endif
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="cancelled-status"
                                               ...
                                               @if(request('status') && in_array('cancelled',request('status'))) checked @endif
                                               @if($initialRequest) checked @endif
                                        >
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="completed-status"
                                               ...
                                               @if(request('status') && in_array('completed',request('status'))) checked @endif
                                               @if($initialRequest) checked @endif
                                        >
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="from_weight" id="from_weight" value="{{request('from_weight')}}"
                                               aria-describedby="from_weight" placeholder="">
                                        {{--                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                    </div>
                                    <div class="form-group">
                                        <label for="to_weight">To Weight</label>
                                        <input type="text" class="form-control" name="to_weight" id="to_weight" value="{{request('to_weight')}}"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="to_country" id="to-country">
                                            <option value="">not affect</option>
                                        @foreach(\Kaban\Models\Quote::countries() as $country)
                                                <option value="{{$country}}"
                                                        @if(request('to_country') && request('to_country')==$country) selected @endif
                                                >{{$country}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                    ...
                    @foreach($quotes as $quote)
                        ...
                        <div class="card  my-5">
                            <div
                                ...
                                <span class="title">{{ __('quote number '.$quote->id).' - '.\Kaban\General\Enums\EQuoteStatus::farsi($quote->status) }}</span>
...
{{--                                <input type="checkbox" v-model="cc">--}}
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" id="csv-mark-{{$quote->id}}"
                                           ...
                                           v-model="selectedCsv"
                                    >
                                    <label class="custom-control-label" for="csv-mark-{{$quote->id}}">Mark for csv group download</label>
                                </div>
                                <ul class="list-group">

                                    @if($quote->urls && ($url = $quote->urls->first()) && ($agent = $url->first()->agent))
                                        <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                            <span class="title">Agent ID</span>
                                            <span class="badge badge-primary badge-pill" data-csv-value>{{$agent->id }}</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                            <span class="title">Agent Email</span>
                                            <span class="badge badge-primary badge-pill" contenteditable="true"  data-csv-value>{{$agent->email }}</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                            <span class="title">Agent Name</span>
                                            <span class="badge badge-primary badge-pill" contenteditable="true"  data-csv-value>{{$agent->fname }}</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                            <span class="title">Agent Company</span>
                                            <span class="badge badge-primary badge-pill"  data-csv-value>{{$agent->cname }}</span>
                                        </li>
                                    @else
                                        <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        ...
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{$quote->shipInfo->scompany??'---'}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        <span class="title">Address</span>
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{$quote->shipInfo->saddress??'---'}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        <span class="title">Zip Code</span>
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{$quote->shipInfo->szipcode??'---'}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        <span class="title">Country</span>
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{$quote->shipInfo->scountry??'---'}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        <span class="title">Contact Person</span>
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{$quote->shipInfo->scontactp??'---'}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        <span class="title">Telephone</span>
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{$quote->shipInfo->stelephone??'---'}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        <span class="title">E-mail</span>
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{!empty($quote->shipInfo->semail)?$quote->shipInfo->semail:'---'}}</span>
                                    </li>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        <span class="title">Company Name</span>
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{$quote->shipInfo->rcompany??'---'}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        <span class="title">Address</span>
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{$quote->shipInfo->raddress??'---'}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        <span class="title">Zip Code</span>
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{$quote->shipInfo->rzipcode??'---'}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        <span class="title">Country</span>
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{$quote->shipInfo->rcountry??'---'}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        <span class="title">Contact Person</span>
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{$quote->shipInfo->rcontactp??'---'}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        <span class="title">Telephone</span>
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{$quote->shipInfo->rtelephone??'---'}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center" data-csv-key>
                                        <span class="title">E-mail</span>
                                        <span data-csv-value
                                            class="badge badge-primary badge-pill" contenteditable="true">{{!empty($quote->shipInfo->remail)?$quote->shipInfo->remail:'---'}}</span>
                                    </li>
