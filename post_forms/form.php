...
.outside_container .submit_button{
	font-size: 16px;
		...
		<script type="text/javascript" src="include/form/form7.js?123"></script>
		<script type="text/javascript" src="include/form/embed.js?123"></script><script type="text/javascript">Embed.init('1332349481','');</script>
...
array(13) { 
	["n_item"]=> string(1) "1" 
	["dims"]=> string(23) "1) 23x45x65 => 12 kg | " 
	["t_weight"]=> string(2) "12" 
	["insurance"]=> string(3) "Yes" 
	["desc"]=> string(4) "2222" 
	["lithium_bat"]=> string(3) "Yes" 
	["dg"]=> string(2) "No" 
	["chemical"]=> string(2) "No" 
	["terms"]=> string(0) "" 
	["un"]=> string(0) "" 
	["class"]=> string(0) "" 
	["instruction"]=> string(0) "" 
	["stackable"]=> string(3) "Yes" 
}
*/							
													if(strtolower($_SESSION['data2']['dg'])=='yes' OR strtolower($_SESSION['data2']['lithium_bat'])=='yes' OR strtolower($_SESSION['data2']['chemical'])=='yes')
													{
														//echo "yes<br>";
														$msds_needed = true;
													}
	...
	//echo $shown_type."<br>";
				...
				case 5:
					...
					$locations = dirname(__DIR__) . DIRECTORY_SEPARATOR  ."Documents" . DIRECTORY_SEPARATOR . time() . DIRECTORY_SEPARATOR  ."";
					//echo $locations."<br>";
					if(!is_dir($locations))
					{
						mkdir($locations, 0755, true);
					}
					if(isset($_FILES['RESULT_MatrixTextField-attachments']['name']) AND is_array($_FILES['RESULT_MatrixTextField-attachments']['name']) AND count($_FILES['RESULT_MatrixTextField-attachments']['name'])>0){
						foreach($_FILES['RESULT_MatrixTextField-attachments']['name'] as $k => $upload){
							if(isset($_FILES['RESULT_MatrixTextField-attachments']['name'][$k]) AND $_FILES['RESULT_MatrixTextField-attachments']['name'][$k] !="" AND $_FILES['RESULT_MatrixTextField-attachments']['name'][$k]!=null){
								
								$target_dir = $locations;
								
								$target_file = $target_dir . basename($_FILES['RESULT_MatrixTextField-attachments']['name'][$k]);
								$uploadOk = 1;
								$imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
								$format = explode(".",basename($_FILES['RESULT_MatrixTextField-attachments']['name'][$k]));
								$format = strtolower($format[(count($format)-1)]);
								$filename = basename($_FILES['RESULT_MatrixTextField-attachments']['name'][$k]);
								if($_FILES["RESULT_MatrixTextField-attachments"]["size"][$k] > 52428801) {
									$_SESSION['error_m'] .= basename( $_FILES['RESULT_MatrixTextField-attachments']['name'][$k])." Invalid file size<br>";
									$uploadOk = 0;
									...
									$_SESSION['error_m'] .= basename( $_FILES['RESULT_MatrixTextField-attachments']['name'][$k])." Invalid file format<br>";
									$uploadOk = 0;
								} 
								if ($uploadOk == 0) {
									$_SESSION['error_m'] .= basename( $_FILES['RESULT_MatrixTextField-attachments']['name'][$k])." Sorry, your file was not uploaded.<br>";
								} else {
									if (move_uploaded_file($_FILES['RESULT_MatrixTextField-attachments']['tmp_name'][$k], $target_file)) {
										$_SESSION['attachments'][] = $target_file;
										//$error_m .= "The file ". basename( $_FILES['RESULT_MatrixTextField-attachments']['name'][$k]). " has been uploaded.<br>";
							...
							{
								$_SESSION['error_m'] .= basename( $_FILES['RESULT_MatrixTextField-attachments']['name'][$k])." Invalid file name or not selected<br>";
							}
						}
					}
					if(count($_SESSION['attachments']) == count($_FILES['RESULT_MatrixTextField-attachments']['name']) or (count($_FILES['RESULT_MatrixTextField-attachments']['name'])==1 AND $_FILES['RESULT_MatrixTextField-attachments']['name'][0]==''))
					{
					...
					if(isset($_SESSION['data2']) AND isset($_POST['RESULT_RadioButton-47']) AND array_key_exists($_POST['RESULT_RadioButton-47'], $post_p_contact) AND $post_p_contact[$_POST['RESULT_RadioButton-47']]!='' AND $post_p_contact[$_POST['RESULT_RadioButton-47']]!=null){
						if($post_p_contact[$_POST['RESULT_RadioButton-47']]=='Email' OR (isset($_POST['RESULT_RadioButton-48']) AND array_key_exists($_POST['RESULT_RadioButton-48'], $post_contact_time) AND $post_contact_time[$_POST['RESULT_RadioButton-48']]!='' AND $post_contact_time[$_POST['RESULT_RadioButton-48']]!=null)){
							...
							if(isset($_POST['have_acc']) AND $_POST['have_acc']=="yes")
							{
								...
								{
									$qq = mysql_query("SELECT count(*) as counter, email, pwd,company,status,GBP_current_balance,EUR_current_balance,USD_current_balance,fname,lname FROM `users` WHERE `uname`='".$_POST['RESULT_TextField-4900']."'") or die(mysql_error());
									...
									if($form_row['counter']==1)
									{
										...
										{
											$_SESSION['error_user'] = "Your account is not allowed to put new quote.";
										}/*
										elseif(($form_row['GBP_current_balance']+$form_row['EUR_current_balance']+$form_row['USD_current_balance'])<500)
										{
											$_SESSION['error_user'] = "Your diposit is too low, Please charge your account first.";
										}*/
										elseif(isset($_POST['RESULT_TextField-4901']) AND trim($_POST['RESULT_TextField-4901'])!="" AND $_POST['RESULT_TextField-4901']!=null)
										{
...
";
	...
	$q = "SELECT * FROM `agents_official_meta` WHERE `cover_counteries` LIKE '%".$_SESSION['data']['from']."%' ORDER by `id` DESC";
	$oores = mysql_query($q);
...
require '../admin/mailer/PHPMailerAutoload.php';
	...
	{
/*
$file = "/home/bookingparcel/public_html/Documents/1475274697/netspeed.png";
$old = "/home/bookingparcel/public_html/Documents/1475274697/";
$new = "/home/bookingparcel/public_html/Documents/660/msds/";

$res = str_replace($old, $new, $file);
echo $res;

rename($file, $res);
*/
		$old_loc = $_SESSION['locations'];
		$new_loc = dirname(__DIR__) . DIRECTORY_SEPARATOR  ."Documents" . DIRECTORY_SEPARATOR .$id. DIRECTORY_SEPARATOR  ."msds". DIRECTORY_SEPARATOR  ."";
//echo "old_loc : ".$old_loc."<br>";
//echo "new_loc : ".$new_loc."<br>";
		if(!is_dir($new_loc))
		{
...
//echo "newlocation : ".$newlocation."<br>";
...
/*
old_loc : /home/bookingparcel/public_html/Documents/1477644532/
new_loc : /home/bookingparcel/public_html/Documents/773/msds/
format : pdf
location : /home/bookingparcel/public_html/Documents/1477644532/4-g-bargh.pdf
newlocation : /home/bookingparcel/public_html/Documents/773/msds/4-g-bargh.pdf
yes
format : pdf
location : /home/bookingparcel/public_html/Documents/1477644532/cable.pdf
newlocation : /home/bookingparcel/public_html/Documents/773/msds/cable.pdf
yes
format : xlsx
location : /home/bookingparcel/public_html/Documents/1477644532/ORICO Product price 1395-05-19.xlsx
newlocation : /home/bookingparcel/public_html/Documents/773/msds/ORICO Product price 1395-05-19.xlsx
*/
...
<?php } ?>
	...
	elseif($shown_type==5){
		?>	
	<form method="post" id="FSForm" action="form.php" enctype="multipart/form-data" onsubmit="return Vromansys.Form.processSubmit(this);">
		<div style="display:none;">
		...
		<div class="outside_container"><div class="progressBarWrapper"><div class="progressBarBack" style=" width:50%; "><div class="progressBarText">50%&nbsp;Complete</div></div><div class="progressBarFront"><div class="progressBarText">50%&nbsp;Complete</div></div></div></div>
			...
			<?php
			if($error){
				echo '<div class="form_table invalid" style="margin-bottom:10px"><div class="invalid_message" style="border:none;font-size:1em;padding:6px;text-align:center;">'.$_SESSION['error_m'].'Please fix the problem and try to upload all the files again</div></div>';
			}
		...
		<div id="q30" class="q">
			<a class="item_anchor" name="ItemAnchor38"></a>
			<span class="question top_question"><span style="font-size: small;"><span style="font-size: small;"><span style="font-size: small;">MSDS Files</span><span style="font-size: small;"><span style="font-size: x-small;"> (If you have any)</span></span></span></span><span class="icon">&nbsp;</span></span>
			<table class="text_list">
				<tbody>
					<tr class="matrix_row_light">
						<td><input type="file" name="RESULT_MatrixTextField-attachments[]" accept=".gif,.jpg,.jpeg,.png,.pdf,.zip,.rtf,.doc,.docx,.xls,.xlsx"></td>
						<td><img class="svg add" height="16" src="images/icons/formIcons/add.svg"> 
							<img class="gif add" height="16" src="images/icons/fam/add.png">
							<img class="svg del" height="16" src="images/icons/formIcons/delete.svg"> 
							<img class="gif del" height="16" src="images/icons/fam/delete.png">
...
<div class="form_table">
	...
	<div id="q101" class="q required">
		<a class="item_anchor" name="ItemAnchor47"></a>
		<p style="padding:0 30px;"><b>Note :</b><br>One of our agents will call you back soon.</p>
