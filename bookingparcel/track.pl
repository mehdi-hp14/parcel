...
<font size="2" face="Arial">
	<table style="background-color:#FDF3D0; width: 100%" align="left" cellpading="5">
		<tr>
			...
			Please enter the Tracking No. of either DHL ,UPS, DPD,TNT ,Aramex and Fedex shipment and press Track button.
			</td>
		</tr>
	<form name="form" class="nofrm" method="POST" action="$script">
		...
		<tr>
			<td style="vertical-align: middle; width: 50px" valign="middle"><img src="$scrip/img/services/logo_ukmail.gif" width="50" height="50" border="0"></td>
			<td style="vertical-align: middle; width: 300px"> UKMail  HAWB No.:</td>
			<td style="vertical-align: middle; width: 250px"><input name="ukmail" style="height:20px;" type="text" size="15" /></td>

				
		</tr>
		<tr>
			<td style="vertical-align: middle; width: 50px" valign="middle"><img src="$scrip/img/services/ups_logo.gif" width="50" height="50" border="0"></td>
			<td style="vertical-align: middle; width: 300px"> UPS Tracking AWB No.:</td>
			<td style="vertical-align: middle; width: 250px"><input name="ups" style="height:20px;" type="text" size="15" /></td>
		</tr>
		<tr>

			<td style="vertical-align: middle; width: 50px" valign="middle"><img src="$scrip/img/services/tnt_logo.jpg" width="50" height="50" border="0"></td>
			<td style="vertical-align: middle; width: 300px"> TNT Tracking AWB No.:</td>
			<td style="vertical-align: middle; width: 250px"><input name="tnt" style="height:20px;" type="text" size="15" /></td>
		</tr>
		<tr>
			<td style="vertical-align: middle; width: 50px" valign="middle"><img src="$scrip/img/services/aramex_logo.gif" width="50" height="50" border="0"></td>
			<td style="vertical-align: middle; width: 300px"> ARAMEX Tracking AWB No.:</td>
			<td style="vertical-align: middle; width: 250px"><input name="aramex" style="height:20px;" type="text" size="15" /></td>
		
		</tr>
		<tr>
			<td style="vertical-align: middle; width: 50px" valign="middle"><img src="$scrip/img/services/fedex_logo.jpg" width="50" height="50" border="0"></td>
			<td style="vertical-align: middle; width: 300px"> Fedex Tracking AWB No.:</td>
			<td style="vertical-align: middle; width: 250px"><input name="fedex" style="height:20px;" type="text" size="15" /></td>
...
sub track{
	unless ($dhl || $dpd || $awb || $ukmail|| $ups|| $tnt|| $aramex|| $fesex|| $car1 || $car2) {&error_page("You must specify a number for tracking"); exit;} 
