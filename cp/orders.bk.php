...
class PView extends SecurePage
{
	...
	*/
	...
	cargo@europostexpress.co.uk<br>
							...
							$mailer->SendMail(array('email'=>'quote@bookingparcel.com', 'name'=>'BookingParcel'), array('email'=>'cargo@europostexpress.co.uk', 'name'=>'EuroPost Express'), $subject, $body);
							...
							if($official_office!=null AND $official_office['master_email']!='' AND $official_office['master_email']!=null)
							{
								$mailer = null;
								$mailer = new MailerClass();
								$mailer->SendMail(array('email'=>'quote@bookingparcel.com', 'name'=>'BookingParcel'), array('email'=>$official_office['master_email'], 'name'=>$official_office['oname']), $subject, $body);
								$mailer = null;
							}
