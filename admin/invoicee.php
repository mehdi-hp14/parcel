...
{
	$price_for_office = ($row['offer_price'] * ((100-$row['discount'])/100));
}
elseif($row['discount_type']=='amount'){
	$price_for_office = ($row['offer_price'] - $row['discount']);
}
...
{
	$vat = $price_for_office * $row['vat'] / 100;
}
?>
	Here is the invoice for our accountancy : <br>
	<table cellpadding='5' cellspacing='1' style='margin-left:auto;margin-right:auto;width:100%;border:0px;font-family:tahoma;font-size:12px;direction:ltr;border:thin solid #777;'>
		<tbody>
			<tr>
						...
						<tbody>
							<tr>
								<td style="padding:5px;" width="55%">
									<b>Europost Express (UK) Ltd</b><br>Unit W13, Research House Business Centre<br>Fraser Road ,<br>Perivale , Middx<br>UB6 7AQ<br>Tel: +44 208 53733286<br>Fax:+44 208 537 3293<br>VAT No. 220335165<br>EORI No: GB220 3351 65000
								</td>
							...
							<tr>
										...
										<tr>
											<td style="padding:5px; min-height:300px;">
												<p style="color:#F90004">
													<textarea name="address_a" style="margin: 0px; width: 293px; height: 95px;"></textarea>
												</p>
											</td>
										</tr>
									</table>
									...
									<table border='1' bordercolor='#777' style='min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
										...
										<tr>
											...
											<td style="padding:5px; text-align:center;">
												<input name="date_a" type="text" value="<?php echo date("d").".".date("m").".".date("Y"); ?>">
											</td>
								...
								$tid .= $id;
										...
										<tr>
											...
											<td style="padding:5px; text-align:center;">
												<input name="invoice_num_a" type="text" value="<?php echo $invoice_no; ?>">
											</td>
							...
							<tr>
								<td colspan="2">
									...
									<table border='1' bordercolor='#777' style='min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
										<tr>
											<td style="padding:15px;" width="55%">Descriptionِ</td>
											<td style="padding:15px;" width="5%">Qty</td>
											<td style="padding:15px;" width="20%">Unit Price(<?php echo $row['currency']; ?>)</td>
											<td style="padding:15px;" width="20%">Total Price(<?php echo $row['currency']; ?>)</td>
										</tr>
										<tr>
											...
											<td style="padding:5px; text-align:center;"><?php echo number_format($price_for_office,2); ?> <?php echo $row['currency']; ?></td>
											<td style="padding:5px; text-align:center;"><?php echo number_format($price_for_office,2); ?> <?php echo $row['currency']; ?></td>
										...
										<tr>
											...
											<td style="text-align:center;" colspan="2">
												...
												<table  border='1' bordercolor='#777' style='min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
													<tr>
														<td style="padding:15px;" width="50%">SUB TOTAL  (<?php echo $row['currency']; ?>)</td>
														<td style="padding:15px;" width="50%"><?php echo number_format($price_for_office,2); ?> <?php echo $row['currency']; ?></td>
													</tr>
													<tr>
														<td style="padding:15px;" width="50%">VAT@20.00% (<?php echo $row['currency']; ?>)</td>
														<td style="padding:15px;" width="50%"><?php echo number_format($vat,2); ?> <?php echo $row['currency']; ?></td>
													</tr>
													<tr>
														<td style="padding:15px; font-weight:bold;" width="50%">TOTAL</td>
														<td style="padding:15px;" width="50%"><?php echo number_format(($price_for_office+$vat),2); ?> <?php echo $row['currency']; ?></td>
													</tr>
												</table>
											</td>
			...
			<tr>
				<td colspan="2" style='background-color:#f5f5f5;padding:25px;'>
					PLEASE REMIT THE ABOVE AMOUNT TO THE FOLLOWING ACCOUNT:<br>Account Name: Europost Express (UK) Limited<br>Europost Accounts<br>(£) GBP A/C No.: 31892150<br>Sortcode: 40 – 46 – 09<br>IBAN: GB65 MIDL 4046 0931 8921 50<br>BIC: MIDLGB2162K<br>Bank SWIFT Code: MIDLGB22<br>Euro A/C No.: 76899401<br>IBAN: GB08 MIDL 4005 1576 8994 01<br>BIC/SWIFT Code: MIDLGB22<br>($) USD A/C No. 76899393<br>IBAN: GB30 MIDL 4005 1576 8993 93<br>BIC/ SWIFT Code: MIDLGB22
				</td>
			</tr>
		</tbody>
	</table>
							...
							<tr>
								<td>
									<table border='1' bordercolor='#777' style='min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
										...
										<tr>
											<td style="padding:5px; min-height:300px;">
												<p style="color:#F90004">
													<textarea name="address" style="margin: 0px; width: 293px; height: 95px;"></textarea>
												</p>
											</td>
										</tr>
									</table>
								...
								<td>
									<table border='1' bordercolor='#777' style='min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
										...
										<tr>
											...
											<td style="padding:5px; text-align:center;">
												<input name="date" type="text" value="<?php echo date("d").".".date("m").".".date("Y"); ?>">
											</td>
								...
								$tid .= $id;
										...
										<tr>
											...
											<td style="padding:5px; text-align:center;">
												<input name="invoice_num" type="text" value="<?php echo $invoice_no; ?>">
											</td>
								...
								<td colspan="2">
									...
									<table border='1' bordercolor='#777' style='min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
										...
										<tr>
											...
											<td style="padding:5px; text-align:center;">1</td>
											<td style="padding:5px; text-align:center;"><?php echo number_format($row['offer_price'],2); ?> <?php echo $row['currency']; ?></td>
											<td style="padding:5px; text-align:center;"><?php echo number_format($row['offer_price'],2); ?> <?php echo $row['currency']; ?></td>
										...
										<tr>
											...
											<td style="text-align:center;" colspan="2">
												...
												<table  border='1' bordercolor='#777' style='min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
													<tr>
														<td style="padding:15px;" width="50%">SUB TOTAL  (<?php echo $row['currency']; ?>)</td>
														<td style="padding:15px;" width="50%"><?php echo number_format($row['offer_price'],2); ?> <?php echo $row['currency']; ?></td>
													</tr>
													<tr>
														<td style="padding:15px;" width="50%">VAT@20.00% (<?php echo $row['currency']; ?>)</td>
														...
														elseif($row['export']=='domestic')
														{
															$vat = $row['offer_price'] * $row['vat'] / 100;
														}
														echo number_format($vat,2); ?> <?php echo $row['currency']; ?></td>
													</tr>
													<tr>
														<td style="padding:15px; font-weight:bold;" width="50%">TOTAL</td>
														<td style="padding:15px;" width="50%"><?php echo number_format(($row['offer_price'] + $vat),2); ?> <?php echo $row['currency']; ?></td>
													</tr>
												</table>
											</td>
...
{
	$price_for_office = ($row['offer_price'] * ((100-$row['discount'])/100));
	$discount = ($row['offer_price'] * (($row['discount'])/100));
}
...
?>
	...
	<table cellpadding='5' cellspacing='1' border='0' style='margin-left:auto;margin-right:auto;width:100%;border:0px;font-family:tahoma;font-size:12px;direction:ltr;border:none'>
		<tbody>
			<tr>
				<td style='background-color:#ffcc33;text-align:left;font-weight:bold;color:#ff3333;' width='80%'>
					Dear Accounant ,<br>Here is the invoice of order by the Tracking ID of <?php echo $row['tid']; ?>:
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<table border='1' bordercolor='#777' style='padding-top:0px;float:right;min-height:166px;margin-left:auto;margin-right:auto;width:88%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
										...
										<tr>
											<td style="padding:5px; text-align:center;">
												<span style="font-weight:bold;">INV NO.</span>
											</td>
							...
							<tr>
								<td colspan="2">
									...
									<table border='1' bordercolor='#777' style='min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
										<tr>
											<td style="padding:15px; text-align:center;font-weight:bold;" width="55%">Descriptionِ</td>
											<td style="padding:15px; text-align:center;font-weight:bold;" width="5%">Qty</td>
											<td style="padding:15px; text-align:center;font-weight:bold;" width="20%">Unit Price(<?php echo $row['currency']; ?>)</td>
											<td style="padding:15px; text-align:center;font-weight:bold;" width="20%">Total Price(<?php echo $row['currency']; ?>)</td>
										</tr>
										<tr>
											<td style="padding:5px; min-height:100px;">
										...
										<tr>
											<td style="padding:5px;">
												<?php echo $row['discount']." ".($row['discount_type']=='percent' ? '%' : $row['currency']). " Discount"; ?>
											</td>
											<td style="padding:5px; text-align:center;"></td>
											<td style="padding:5px; text-align:center;"></td>
											<td style="padding:5px; text-align:center;">
											<?php echo "".number_format($discount,2)." ".($row['currency']). "";  ?>
											</td>
										...
										<tr>
											...
											<td style="text-align:center;" colspan="2">
												...
												<table  border='1' bordercolor='#777' style='min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
													<tr>
														<td style="padding:5px;font-size:10px;" width="50%">SUB TOTAL  (<?php echo $row['currency']; ?>)</td>
														<td style="padding:5px;" width="50%"><?php  echo number_format($price_for_office,2); ?> <?php echo $row['currency']; ?></td>
													</tr>
													<tr>
														<td style="padding:5px;" width="50%">VAT@20.00% (<?php echo $row['currency']; ?>)</td>
														<td style="padding:5px;" width="50%"><?php echo number_format($vat,2); ?> <?php echo $row['currency']; ?></td>
													</tr>
													<tr>
														<td style="padding:5px; font-weight:bold;" width="50%">TOTAL</td>
														<td style="padding:5px; font-weight:bold;" width="50%"><?php echo number_format(($price_for_office+$vat),2); ?> <?php echo $row['currency']; ?></td>
													</tr>
												</table>
											</td>
										...
										<tr>
											...
											<td style="text-align:center;" colspan="2">
												...
												<table  border='1' bordercolor='#777' style='min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
													<tr>
														<td style="padding:5px;font-size:10px;" width="50%">SUB TOTAL  (<?php echo $row['currency']; ?>)</td>
														<td style="padding:5px;" width="50%"><?php  echo number_format($row['offer_price'],2); ?> <?php echo $row['currency']; ?></td>
													</tr>
													<tr>
														<td style="padding:5px;" width="50%">VAT@20.00% (<?php echo $row['currency']; ?>)</td>
													...
													<tr>
														<td style="padding:5px; font-weight:bold;" width="50%">TOTAL</td>
														<td style="padding:5px; font-weight:bold;" width="50%"><?php echo number_format(($row['offer_price']+$vat),2); ?> <?php echo $row['currency']; ?></td>
													</tr>
												</table>
											</td>
...
/*
$accountancy_msg='<table cellpadding=\'5\' cellspacing=\'1\' style=\'margin-left:auto;margin-right:auto;width:100%;border:0px;font-family:tahoma;font-size:12px;direction:ltr;border:thin solid #777;\'>
		<tbody>
			<tr>
				<td style=\'background-color:#ffcc33;text-align:left;font-weight:bold;color:#ff3333;\' width=\'80%\'>
								...
								<td colspan="2">
									...
									<table border=\'1\' bordercolor=\'#777\' style=\'min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;\'>
										<tr>
											<td style="padding:15px;" width="55%">Descriptionِ</td>
											<td style="padding:15px;" width="5%">Qty</td>
											<td style="padding:15px;" width="20%">Unit Price('. $row['currency'].')</td>
											<td style="padding:15px;" width="20%">Total Price('.$row['currency'].')</td>
										</tr>
										<tr>
											<td style="padding:5px; min-height:100px;">
											...
											<td style="padding:5px; text-align:center;">1</td>
											<td style="padding:5px; text-align:center;">'.number_format($price_for_office,2).' '.$row['currency'].'</td>
											<td style="padding:5px; text-align:center;">'.number_format($price_for_office,2).' '.$row['currency'].'</td>
										...
										<tr>
											...
											<td style="text-align:center;" colspan="2">
												...
												<table  border=\'1\' bordercolor=\'#777\' style=\'min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;\'>
													<tr>
														<td style="padding:15px;" width="50%">SUB TOTAL  ('. $row['currency'].')</td>
														<td style="padding:15px;" width="50%">'.number_format($price_for_office,2) .' '.$row['currency'].'</td>
													</tr>
													<tr>
														<td style="padding:15px;" width="50%">VAT@20.00% ('.$row['currency'].')</td>
														<td style="padding:15px;" width="50%">'.number_format($vat,2).' '.$row['currency'].'</td>
													</tr>
													<tr>
														<td style="padding:15px; font-weight:bold;" width="50%">TOTAL</td>
														<td style="padding:15px;" width="50%">'.number_format(($price_for_office + $vat),2).' '.$row['currency'].'</td>
													</tr>
												</table>
											</td>
								...
								<td colspan="2">
									...
									<table border=\'1\' bordercolor=\'#777\' style=\'min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;\'>
										<tr>
											<td style="padding:15px; text-align:center;font-weight:bold;" width="55%">Descriptionِ</td>
											<td style="padding:15px; text-align:center;font-weight:bold;" width="5%">Qty</td>
											<td style="padding:15px; text-align:center;font-weight:bold;" width="20%">Unit Price('.$row['currency'].')</td>
											<td style="padding:15px; text-align:center;font-weight:bold;" width="20%">Total Price('.$row['currency'].')</td>
										</tr>
										<tr>
											<td style="padding:5px; min-height:100px;">
												<span style="font-weight:bold;">
											...
											<td style="padding:5px; text-align:center;">1</td>
											<td style="padding:5px; text-align:center;">'.number_format($row['offer_price'],2).' '.$row['currency'].'</td>
											<td style="padding:5px; text-align:center;">'.number_format($row['offer_price'],2).' '.$row['currency'].'</td>
										</tr>
										'.(($discount>0) ? "
										<tr>
											<td style=\"padding:5px;\">".$row['discount']." ".($row['discount_type']=='percent' ? '%' : $row['currency']). " Discount
											</td>
											<td style=\"padding:5px; text-align:center;\"></td>
											<td style=\"padding:5px; text-align:center;\"></td>
											<td style=\"padding:5px; text-align:center;\">".number_format($discount,2)." ".($row['currency']). "
											</td>
										...
										<tr>
											...
											<td style="text-align:center;" colspan="2">
												...
												<table  border=\'1\' bordercolor=\'#777\' style=\'min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;\'>
													<tr>
														<td style="padding:5px;font-size:10px;" width="50%">SUB TOTAL  ('.$row['currency'].')</td>
														<td style="padding:5px;" width="50%">'. number_format($price_for_office,2).' '.$row['currency'].'</td>
													</tr>
													<tr>
														<td style="padding:5px;" width="50%">VAT@20.00% ('.$row['currency'].')</td>
														<td style="padding:5px;" width="50%">'.number_format($vat,2).' '.$row['currency'].'</td>
													</tr>
													<tr>
														<td style="padding:5px; font-weight:bold;" width="50%">TOTAL</td>
														<td style="padding:5px; font-weight:bold;" width="50%">'.number_format(($price_for_office+$vat),2).' '.$row['currency'].'</td>
													</tr>
												</table>
											</td>
...
//	$mail->AddCC('cargo@epxcargo.co.uk', "BookingParcel(invoices)");
	...
	if (!$mail->send()) {
		...
		$error_m .= "quote1@bookingparcel.com Sent Successfully<br>";
	}
										...
										<tr>
											...
											<td style="text-align:center;" colspan="2">
												...
												<table  border=\'1\' bordercolor=\'#777\' style=\'min-height:166px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;\'>
													<tr>
														<td style="padding:5px;font-size:10px;" width="50%">SUB TOTAL  ('.$row['currency'].')</td>
														<td style="padding:5px;" width="50%">'. number_format($row['offer_price'],2).' '.$row['currency'].'</td>
													</tr>
													<tr>
														<td style="padding:5px;" width="50%">VAT@20.00% ('.$row['currency'].')</td>
														<td style="padding:5px;" width="50%">'.number_format($vat,2).' '.$row['currency'].'</td>
													...
													<tr>
														<td style="padding:5px; font-weight:bold;" width="50%">TOTAL</td>
														<td style="padding:5px; font-weight:bold;" width="50%">'.number_format(($row['offer_price']+$vat),2).' '.$row['currency'].'</td>
													</tr>
												</table>
											</td>
