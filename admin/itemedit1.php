...
<?php
		...
		<tr>
		<?php if($row['paid']=='yes'){?>
			<td style="padding:5px;text-align:center;" colspan="3"><button class="btn btn-green" name="submit" type="button" onclick="window.open('invoice.php?id=<?php echo $id;?>&type=1','invoice','scrollbars=yes,status=yes,resizable=yes,toolbar=yes,width=980,height=600');return false;">Create Invoice For Customer</button></td>
			<td style="padding:5px;text-align:center;" colspan="3"><button class="btn btn-teal" name="submit" type="button" onclick="window.open('invoice.php?id=<?php echo $id;?>&type=0','invoice','scrollbars=yes,status=yes,resizable=yes,toolbar=yes,width=980,height=600');return false;">Create Invoice For Office</button></td>
		<?php 
		}
		else{?>
			<td style="padding:5px;text-align:center;" colspan="3"><button class="btn btn-grey " name="submit" type="button">Create Invoice For Customer (Not Paid Yet)</button></td>
			<td style="padding:5px;text-align:center;" colspan="3"><button class="btn btn-grey " name="submit" type="button">Create Invoice For Office (Not Paid Yet)</button></td>
		<?php 
		}
		?>	
			<td style="padding:5px;text-align:center;" colspan="2"><button class="btn btn-teal" name="submit" type="button" onclick="window.open('shipping.php?id=<?php echo $id;?>','invoice','scrollbars=yes,status=yes,resizable=yes,toolbar=yes,width=980,height=600');return false;">Shipment Instruction</button></td>
		</tr>
		<tr>
