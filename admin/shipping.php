...
//	var_dump($emails);echo "<br>";
	...
	HS code /Codes</span>
                            ...
                            <br>
                            And Consignee in MAWB will be:<br>
                            <textarea name="consignee" style="margin: 0px; width: 339px; height: 150px;"><?php if ($user_info != null and is_array($user_info)) {
                            ...
                            <div style="text-align:center;">
                                <button class="btn" name="submit" value="send" type="submit">Send To Agent</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn" name="submit" value="save" type="submit">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="grid_12">
                <div class="box round first">
                    <h2>Shippment Instruction</h2>
                    <div class="block">
                        <button type="button" name="print" class="btn btn-green" onclick="printContent('print')">Print the bellow E-mail Content</button>
                        <br>
                        <div id='print'>
