		...
		<tbody>
				...
				<td colspan="2" style='background-color:#f5f5f5;padding:25px;'>
					<table  border='1' bordercolor='#777' style='margin-left:auto;margin-right:auto;width:90%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
						<tbody>
							...
							<tr>
								<td>
									<table border='1' bordercolor='#777' style='min-height:66px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
										<tr>
									...
									<table border='1' bordercolor='#777' style='min-height:66px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
										...
										<tr>
											...
											<td style="text-align:center;" colspan="2">
												...
												<table  border='1' bordercolor='#777' style='min-height:66px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
													<tr>
														<td style="padding:5px;" width="50%">SUB TOTAL  (<?php echo $currency; ?>)</td>
													...
													<tr>
														<td style="padding:5px; font-family:arial;font-size:19px; font-weight:bold;" width="50%">TOTAL</td>
														<td style="padding:5px;" width="50%"><?php echo number_format(($price_for_office+$vat+$dif_cost),2); ?> <?php echo $currency; ?></td>
													</tr>
												</table>
											</td>
			...
			<tr>
				<td colspan="2" style='background-color:#f5f5f5;padding:10px;'>
					PLEASE REMIT THE ABOVE AMOUNT TO THE FOLLOWING ACCOUNT:<br>Account Name: Europost Express (UK) Limited<br>Bank Name: HSBC<br>Europost Accounts<br>(£) GBP A/C No.: 31892150<br>Sort Code: 404609<br>IBAN: GB05 HBUK 4046 0931 8921 50<br>BIC: HBUKGB4162k<br>Bank SWIFT Code: HBUKGB4B<br>Euro A/C No.: 76899401<br>Sort Code: 401276<br>IBAN: GB64 HBUK 4012 7676 8994 01<br>BIC: HBUKGB41CM1<br>BIC/SWIFT Code: HBUKGB4B
				</td>
			</tr>
		</tbody>
	</table>
										...
										<tr>
											...
											<td style="text-align:center;" colspan="2">
												...
												<table  border='1' bordercolor='#777' style='min-height:66px;margin-left:auto;margin-right:auto;width:100%;border-collapse:collapse;border-color:#777;font-size:12px;text-align:left;'>
													<tr>
														<td style="padding:5px;" width="50%">SUB TOTAL  (<?php echo $currency; ?>)</td>
														<td style="padding:5px;" width="50%"><?php echo number_format($dif_cost+$offer_price,2); ?> <?php echo $currency; ?></td>
													</tr>
													<tr>
														<td style="padding:5px;" width="50%">VAT@20.00% (<?php echo $currency; ?>)</td>
													...
													<tr>
														<td style="padding:5px; font-family:arial;font-size:19px; font-weight:bold;" width="50%">TOTAL</td>
														<td style="padding:5px;" width="50%"><?php echo number_format(($offer_price + $vat+$dif_cost),2); ?> <?php echo $currency; ?></td>
													</tr>
												</table>
											</td>
...
?>
	...
	<table cellpadding='5' cellspacing='1' border='0' style='margin-left:auto;margin-right:auto;width:100%;border:0px;font-family:arial;font-size:12px;direction:ltr;border:none'>
		<tbody>
			...
			<tr>
				<td colspan="2" style='background-color:#f5f5f5;padding:5px;' id="print">
				...
				<td colspan="2" style='background-color:#f5f5f5;padding:5px;' id="print">
					<table  border='0' style='margin-left:auto;margin-right:auto;width:90%;font-size:12px;text-align:left;'>
						<tbody>
							...
							<tr>
								<td colspan="2" style='background-color:#f5f5f5;padding:3px;'>
								PLEASE REMIT THE ABOVE AMOUNT TO THE FOLLOWING ACCOUNT:<br>Account Name: Europost Express (UK) Limited<br>Bank Name: HSBC<br>Europost Accounts<br>(£) GBP A/C No.: 31892150<br>Sort Code: 404609
								<br>IBAN: GB05 HBUK 4046 0931 8921 50<br>BIC: HBUKGB4162k<br>Bank SWIFT Code: HBUKGB4B
								<br>Euro A/C No.: 76899401<br>Sort Code: 401276<br>IBAN: GB08 MIDL 4005 1576 8994 01<br>BIC/SWIFT Code: HBUKGB4B
...
$accountancy_msg ='
	...
	$mail->setFrom('account@europostexpress.co.uk', 'Cargo EuroPostExpress');
	...
	if (!$mail->send()) {
		...
		$error_m .= "account@europostexpress.co.uk Sent Successfully<br>";
	}
