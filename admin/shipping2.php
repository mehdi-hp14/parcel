...
Tel : +44(0) 7886105417<br>
		...
		$subject = "Introduction and introduce Europost Express agent to shipper for quote ref. EPX-".$country_iso[$row['from']]."-".$country_iso[$row['to']]."-".$id;
...
?>
        <div class="grid_12">
            <div class="box round first">
                ...
                <div class="block">
					<form action="shipping2.php?id=<?php echo $id; ?>" method="post">
<?php
echo "Item ID : ".$id."<br>";
echo "Tracking ID : ".$row['tid']."<br>";

?>
Shipper Email : <input type="text" name="email" value="<?php echo $row2['semail']; ?>"> (Note: only one email is allowed!)<br>
Agent Email : <input type="text" name="aemail" value="<?php echo $agent['emails']; ?>"> (Note: only one email is allowed!)<br>
<br><br><hr>
<input type="hidden" name="t" value="send">

To: <input type="text" name="senderc" value="<?php echo $row2['scompany']; ?>"><br>
CC: <input type="text" name="agent" value="<?php echo $agent['cname']; ?>"> <br><br>


Dear <input type="text" name="senderp" value="<?php echo $row2['scontactp']; ?>"> <br><br>

Herby we introduce our agent <input type="text" name="agent2" value="<?php echo $agent['cname']; ?>"> for arrange pickup and delivery this order with reference <?php echo $row['tid']; ?> and collection Reference <input type="text" name="colref" value="<?php echo (($row2['col_ref'] != '' or $row2['col_ref'] != null ) ? $row2['col_ref'] : "()"); ?>"> .
Please drop off cargo to them and update us with date and time.
...
All of the rights in this order belong to Europost Express (UK) Ltd. The shipper <input type="text" name="sendercc" value="<?php echo $row2['scompany']; ?>"> ,and the Europost Express (UK) ltd agent <input type="text" name="agent3" value="<?php echo $agent['cname']; ?>"> are not allowed to directly communicate and do business (such as current or new further orders) with one another without the full knowledge and consent of Europost Express (UK) Ltd. In the case of breach of this agreement, Europost Express (UK) Ltd may make a formal complaint to The Courts of The United Kingdom or any other relevant country and may claim compensation. By continuing with this order, the shipper and The Europost Express (UK) Ltd agent hereby agree to these terms and conditions. 
<br><br>
Regards<br><br>
Fazel Zohrabpour
<br><br>
