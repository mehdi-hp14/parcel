...
<head>
    ...
    <title>Sent Mails | Booking Parcel Admin</title>
...
$q = "SELECT * FROM `sent_mails` WHERE `id`=".$id." ORDER BY `timestamp` DESC";

$r = mysql_query($q) or die(mysql_error());
if(mysql_num_rows($r)>0){
	$row = mysql_fetch_array($r);
	echo "<pre><button type=\"button\" name=\"print\" class=\"btn btn-green\" onclick=\"printContent('print')\">Print the bellow E-mail Content</button><br><br>Date : ".date("Y/m/d H:i:s",$row['timestamp'])."<br>Message:<br><div id='print'>".$row['body']."<br>Attachment : ".$row['attachment']."</div><hr></pre>";
}
else{
