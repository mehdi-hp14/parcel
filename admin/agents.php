                                ...
                                <form method="post">
                                    ...
                                    <table border="1" style="margin-left:auto;margin-right:auto;width:90%;border-collapse:collapse;border-color:#777;font-size:12px">
                                        ...
                                        <tr style="background-color:#fff;text-align:center;font-weight:bold">
                                            ...
                                            <td style="padding:5px;width:35%;"><select name="country" id="select"><?php foreach ($post_c as $k => $v) {
                                                        echo "<option value='" . $k . "' " . ($r['country'] == $v ? "selected='selected'" : "") . ">" . $v . "</option>";
                                                    } ?></select></td>
                ...
                <div class="box round first">
                    ...
                    <div class="block">
                        ...
                        foreach (range('A', 'Z') as $letter) {
                            print '<a href="?start=' . $letter . '" ' . ($letter == $key ? "style='color: red;text-decoration: none;border-bottom: 1px solid green;'" : "") . '>' . $letter . '</a>&nbsp;';
                        }
                        echo '</p>';
                        $con = mysql_connect(DB_HOST, DB_USER, DB_PASS) or die(mysql_error());
                        mysql_select_db(DB_NAME, $con) or die(mysql_error());
