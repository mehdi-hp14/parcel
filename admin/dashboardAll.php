...
//echo "Avatar : ".($row['avatar']!="" ? "<img src='../cp/Assets/images/avatar/".$row['avatar']."'>" : "None")."<br>";
		if($row['uname']!='' OR $row['uname']!=null)
		{
			...
			$output .="<td class='no-print'>".($row2 && $row2['avatar']!="" ? "<span style='max-width:112px;max-height:48;'><img width=\"112px\" height=\"48px\" src='../cp/Assets/images/avatar/".$row2['avatar']."'></span>" : "None")."</td>";
		}
		else{
			$output .="<td>None</td>";
		}
