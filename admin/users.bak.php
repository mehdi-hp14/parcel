...
if(mysql_num_rows($r)>0){
	...
	while($row = mysql_fetch_array($r)){
		...
		$output .="<tr >";
		$output .="<td >".$_c."</td><td >".$row['id']."</td><td >".$row['fname']." ".$row['lname']."</td><td >".$row['company']."</td><td >".$row['IRR_total_receive']." IRR<br>".$row['EUR_total_receive']." EUR<br>".$row['GBP_total_receive']." GBP<br>".$row['USD_total_receive']." USD</td>"
		."<td >".$row['IRR_current_balance']." IRR<br>".$row['EUR_current_balance']." EUR<br>".$row['GBP_current_balance']." GBP<br>".$row['USD_current_balance']." USD</td>"
		."<td >".$row['IRR_total_order_paid']." IRR<br>".$row['EUR_total_order_paid']." EUR<br>".$row['GBP_total_order_paid']." GBP<br>".$row['USD_total_order_paid']." USD</td>"
